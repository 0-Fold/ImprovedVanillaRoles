...
using IVR.Roles.Crewmate;
using IVR.Roles.Impostor;
using static IVR.Roles.Core.CustomRoleManager;
...
public static class CustomRolesHelper
{
    ...
    public static CustomRoles GetVNRole(this CustomRoles role) // RoleBase: Impostor, Shapeshifter, Crewmate, Engineer, Scientist
    {
        ...
        return role switch
        {
            CustomRoles.ShapeshifterIVR => CustomRoles.Shapeshifter,
            CustomRoles.PhantomIVR => CustomRoles.Phantom,
            CustomRoles.ScientistIVR => CustomRoles.Scientist,
            CustomRoles.EngineerIVR => CustomRoles.Engineer,
            CustomRoles.NoisemakerIVR => CustomRoles.Noisemaker,
            CustomRoles.TrackerIVR => CustomRoles.Tracker,
    ...
    */
    ...
    {
        return target.Is(CustomRoles.EngineerIVR)
        ...
        switch (role)
        {
            ...
            case CustomRoles.Autopsy:
                ...
                if (pc.Is(CustomRoles.Doctor)
                    ...
                    || pc.Is(CustomRoles.ScientistIVR)
            ...
            case CustomRoles.Bait:
                if (pc.Is(CustomRoles.Trapper)
                    ...
                    || pc.Is(CustomRoles.GuardianAngelIVR))
                    return false;
            ...
            case CustomRoles.Tiebreaker:
                if (pc.Is(CustomRoles.Dictator)
                    ...
                    || pc.Is(CustomRoles.Influenced)
                    || pc.Is(CustomRoles.GuardianAngelIVR)) return false;
