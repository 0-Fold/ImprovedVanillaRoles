...
public abstract class OptionItem
{
    ...
    public OptionItem HideInHnS(CustomGameMode value = CustomGameMode.HidenSeekIVR) => Do(i => i.HideOptionInHnS = value);
    ...
    // This Code For Reset All IVR Setting To Default
