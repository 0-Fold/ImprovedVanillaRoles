...
internal static class ChatCommands
{
    ...
    public static bool IsPlayerModerator(string friendCode)
    {
        ...
        const string friendCodesFilePath = "./IVR_DATA/Moderators.txt";
    ...
    private static void DeleteModCommand(ChatController __instance, PlayerControl player, string text, string[] args)
    {
        ...
        File.WriteAllLines("./IVR_DATA/Moderators.txt", File.ReadAllLines("./IVR_DATA/Moderators.txt").Where(x => !x.Contains(remFc)));
    ...
    private static void AddModCommand(ChatController __instance, PlayerControl player, string text, string[] args)
    {
        ...
        File.AppendAllText("./IVR_DATA/Moderators.txt", $"\n{fc}");
...
internal class UpdateCharCountPatch
{
    public static void Postfix(FreeChatInputField __instance)
    {
        ...
        __instance.charCountText.SetText(length <= 0 ? GetString("ThankYouForUsingIVR") : $"{length}/{__instance.textArea.characterLimit}");
